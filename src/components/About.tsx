    ...
    <div style={{ position: "relative", height: "100vh", overflow: "hidden" }}>
      ...
      <div style={styles.wrapper}>
        <div style={styles.container}>
          ...
          <p style={styles.text}>
  I’m Piyush Thakur, a final-year Computer Science student and full-stack
  developer with hands-on experience building scalable MERN stack applications.
  I enjoy developing secure, performant web solutions using React, Node.js, and
  MongoDB, and have practical exposure to AWS cloud services. I’m passionate
  about clean architecture, problem-solving, and turning real-world ideas into
  reliable software.
</p>
        </div>
      </div>
