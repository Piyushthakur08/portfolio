...
const Skills: React.FC = () => {
  ...
  <div style={{ ...styles.card, ...dynamicCardStyle }}>
    <div style={{ ...styles.left, ...dynamicLeftStyle }}>
      <h2 style={styles.heading}>Front-End & Full-Stack Developer</h2>
      <p style={styles.text}>
        I design and build responsive, user-friendly web applications with a
        strong focus on performance and scalability. I work primarily with
        React, JavaScript, and modern UI frameworks, while also developing secure
        backend systems using Node.js, Express, and MongoDB as part of the MERN
        stack.
      </p>
    </div>
