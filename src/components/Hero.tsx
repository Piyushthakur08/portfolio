...
const Hero: React.FC = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      >
        <h1 style={{ ...styles.title, ...dynamicTitleStyle }}>PIYUSH</h1>
        <h1 style={{ ...styles.title, ...dynamicTitleStyle }}>THAKUR</h1>
      </div>
      <div
        style={{
          ...styles.socialLinks,
      ...
      >
        <a href="mailto:piyushthakur9183@gmail.com" style={styles.socialButton}>
          <img
        ...
        <a
          href="https://linkedin.com/in/piyush-thakur-b62176258"
          target="_blank"
          rel="noopener noreferrer"
